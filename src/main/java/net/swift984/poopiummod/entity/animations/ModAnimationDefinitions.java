...
public class ModAnimationDefinitions {
    public static final AnimationDefinition SHITMITE_WALK = AnimationDefinition.Builder.withLength(1.5F).looping()
    ...
    public static final AnimationDefinition SHITMITE_IDLE = AnimationDefinition.Builder.withLength(1.0F).looping()
            .addAnimation("bone2", new AnimationChannel(AnimationChannel.Targets.POSITION,
